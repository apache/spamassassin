...
=item spamc [-c] [-d host] [-f] [-h] [-S] [-p port] [-s max_size] [-u username] [-e command [args]]
...
Just check if the message is spam or not.  Set process exitcode to 1 is message
is spam, 0 if not spam or processing failure occurs.  Will print
