...
Net::SMTP::Server::SmartHost - A simple smarthost module for Net::SMTP::Server.
...
The Net::SMTP::Server::SmartHost module implements simple SMTP client
...
The above example illustrates the use of the Net::SMTP::Server::SmartHost
...
the sender, recipients, message, and next-hop mailserver.  More formally:
  ...
  $relay = new Net::SMTP::Server::SmartHost($from, @to, $msg, $smarthost);
